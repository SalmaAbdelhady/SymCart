                ...
                if (0 === strpos($pathinfo, '/admin/salma/symcart')) {
                    ...
                    if (0 === strpos($pathinfo, '/admin/salma/symcart/orders')) {
                        ...
                        if ($pathinfo === '/admin/salma/symcart/orders/list') {
                            return array (  '_controller' => 'Salma\\SymCartBundle\\Controller\\OrdersAdminController::listAction',  '_sonata_admin' => 'salma_sym_cart.admin.orders',  '_sonata_name' => 'admin_salma_symcart_orders_list',  '_route' => 'admin_salma_symcart_orders_list',);
                        }

                        // admin_salma_symcart_orders_show
                        if (preg_match('#^/admin/salma/symcart/orders/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_salma_symcart_orders_show')), array (  '_controller' => 'Salma\\SymCartBundle\\Controller\\OrdersAdminController::showAction',  '_sonata_admin' => 'salma_sym_cart.admin.orders',  '_sonata_name' => 'admin_salma_symcart_orders_show',));
                        }

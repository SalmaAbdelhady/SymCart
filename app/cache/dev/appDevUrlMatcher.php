    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/assetic')) {
            if (0 === strpos($pathinfo, '/assetic/jquery_js')) {
                ...
                if ($pathinfo === '/assetic/jquery_js_jquery-1.10.2_1.js') {
        ...
        if (0 === strpos($pathinfo, '/css/bootstrap')) {
            ...
            if ($pathinfo === '/css/bootstrap_bootstrap_1.css') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => 'bootstrap_less',  'pos' => 0,  '_format' => 'css',  '_route' => '_assetic_bootstrap_less_0',);
            }
        ...
        if (0 === strpos($pathinfo, '/cart')) {
            if (0 === strpos($pathinfo, '/cart/add')) {
                // cart_add
                if (preg_match('#^/cart/add/(?P<id>\\d+)(?:/(?P<offer>\\d+))?$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_cart_add;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'cart_add')), array (  '_controller' => 'Salma\\SymCartBundle\\Controller\\CartController::addAction',  'offer' => 0,));
                }
                not_cart_add:

                // cart_off_add
                if (0 === strpos($pathinfo, '/cart/addoff') && preg_match('#^/cart/addoff/(?P<id>\\d+)$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_cart_off_add;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'cart_off_add')), array (  '_controller' => 'Salma\\SymCartBundle\\Controller\\CartController::addofferAction',));
                }
                not_cart_off_add:
        ...
        if (0 === strpos($pathinfo, '/off')) {
            // offer_list
            if ($pathinfo === '/off/l') {
                return array (  '_controller' => 'Salma\\SymCartBundle\\Controller\\OfferController::listAction',  '_route' => 'offer_list',);
            }

            // offer_show
            if (preg_match('#^/off/(?P<id>[^/]++)/s$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'offer_show')), array (  '_controller' => 'Salma\\SymCartBundle\\Controller\\OfferController::showAction',));
            }

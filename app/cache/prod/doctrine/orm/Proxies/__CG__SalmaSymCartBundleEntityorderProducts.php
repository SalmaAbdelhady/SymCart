 ...
 */
class orderProducts extends \Salma\SymCartBundle\Entity\orderProducts implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'quantity', 'subtotal', 'product_id', 'order_id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (orderProducts $proxy) {

 ...
 */
class Wishlist extends \Salma\SymCartBundle\Entity\Wishlist implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'user_id', 'product', 'name', 'items');
        }
    ...
    public function save($session)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'save', array($session));
    ...
    public function emptyCart($session)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'emptyCart', array($session));

        return parent::emptyCart($session);
    }
    ...
    public function remvItem($itemId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'remvItem', array($itemId));

        return parent::remvItem($itemId);
    }

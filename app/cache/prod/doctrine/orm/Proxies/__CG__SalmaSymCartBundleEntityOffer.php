 ...
 */
class Offer extends \Salma\SymCartBundle\Entity\Offer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'discount', 'startDate', 'endDate', 'status', 'product');
        }

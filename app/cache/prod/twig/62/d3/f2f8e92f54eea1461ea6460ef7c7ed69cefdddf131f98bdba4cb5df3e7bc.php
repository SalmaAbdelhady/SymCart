...
class __TwigTemplate_62d3f2f8e92f54eea1461ea6460ef7c7ed69cefdddf131f98bdba4cb5df3e7bc extends Twig_Template
{
    ...
    <ul class=\"";
        ...
        ";
            ...
            $template->display(array_merge($context, array("name" => "first", "text" => $this->env->getExtension('translator')->trans(((array_key_exists("first_text", $context)) ? (_twig_default_filter((isset($context["first_text"]) ? $context["first_text"] : null), "«")) : ("«")), array(), "pagination"), "page" => ((array_key_exists("first", $context)) ? ((isset($context["first"]) ? $context["first"] : null)) : (null)), "clickable" => (array_key_exists("first", $context) && ((isset($context["current"]) ? $context["current"] : null) != (isset($context["first"]) ? $context["first"] : null))))));
            // line 11
            echo "
        ";
            // line 12
            $template = $this->env->resolveTemplate((isset($context["item"]) ? $context["item"] : null));
            $template->display(array_merge($context, array("name" => "prev", "text" => ("‹ " . $this->env->getExtension('translator')->trans(((array_key_exists("prev_text", $context)) ? (_twig_default_filter((isset($context["prev_text"]) ? $context["prev_text"] : null), "Previous")) : ("Previous")), array(), "pagination")), "page" => ((array_key_exists("previous", $context)) ? ((isset($context["previous"]) ? $context["previous"] : null)) : (null)), "clickable" => array_key_exists("previous", $context))));
            // line 18
            echo "
        ";
            // line 19
        ...
        ";
            // line 24
            $template = $this->env->resolveTemplate((isset($context["item"]) ? $context["item"] : null));
            $template->display(array_merge($context, array("name" => "next", "text" => ($this->env->getExtension('translator')->trans(((array_key_exists("next_text", $context)) ? (_twig_default_filter((isset($context["next_text"]) ? $context["next_text"] : null), "Next")) : ("Next")), array(), "pagination") . " ›"), "page" => ((array_key_exists("next", $context)) ? ((isset($context["next"]) ? $context["next"] : null)) : (null)), "clickable" => array_key_exists("next", $context))));
            // line 31
            echo "
        ";
            // line 33
            $template = $this->env->resolveTemplate((isset($context["item"]) ? $context["item"] : null));
            $template->display(array_merge($context, array("name" => "last", "text" => $this->env->getExtension('translator')->trans(((array_key_exists("last_text", $context)) ? (_twig_default_filter((isset($context["last_text"]) ? $context["last_text"] : null), "»")) : ("»")), array(), "pagination"), "page" => ((array_key_exists("last", $context)) ? ((isset($context["last"]) ? $context["last"] : null)) : (null)), "clickable" => (array_key_exists("last", $context) && ((isset($context["current"]) ? $context["current"] : null) != (isset($context["last"]) ? $context["last"] : null))))));
            // line 40
            echo "    </ul>
";
        }
